...
const Download: React.FC = () => {
    ...
    const handleDownload = () => {
        window.location.href = "https://github.com/Numidiaware/Folder-Comments/releases/download/1.0.0/FolderCommentsSetup_1.0.0.exe";
    };
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-brand-50 dark:bg-slate-800 border border-brand-200 dark:border-slate-700 rounded-lg p-6 mb-8 flex flex-col md:flex-row items-center justify-between gap-6 transition-colors duration-200">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300 mb-4">Released October 2023 • Windows 7/8/10/11 (32/64-bit)</p>
